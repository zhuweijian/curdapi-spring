...
public class ApiConfig implements AutoCloseable {
     ...
     *
     * @param hikariDatasourceProperties a {@link Properties} object.
     */
     ...
     * @param portNumber a {@link String} object.
     * @param serverHostName a {@link String} object.
     * @param datasourceClassName a {@link String} object.
     */
...
//        hikariConfig.setMinimumIdle(5);
     ...
     *
     * @param cachedTableMeta a {@link Map} object.
     */
     ...
     * @return a boolean.
     */
    public boolean tableAuthorizer(RequestHandler.Actions action, String database, String table) {
        //todo 可以在这里添加权限。比如：只允许读权限， 根据action判断
        return true;
    }
     ...
     * @param context a {@link HttpServletRequest} object.
     ...
     *
     * @param action a {@link RequestHandler.Actions} object.
     * @param database a {@link String} object.
     * @param table a {@link String} object.
     * @param ids an array of {@link String} objects.
     * @param input a {@link Map} object.
     * @return a {@link RequestHandler.Actions} object.
     */
